...
namespace MainApp
{
  public class CustomHandlerPageApplicationModelProvider : DefaultPageApplicationModelProvider, IPageApplicationModelProvider
  {
    public CustomHandlerPageApplicationModelProvider(IOptions<MvcOptions> mvcOptions)
      : base(mvcOptions)
    {
    }

    int IPageApplicationModelProvider.Order => base.Order + 1;
